...
/**
 * Modified version of ArrayDeque.
 * Edited by UwU_Snek
 *
 *
 *
...
/**
 * An ArrayDeque with protected head, tail and elements to allow subclasses to
 * access these fields.
 *
 ...
 * @since 1.6
 */
public class AccessibleArrayDeque<E> extends AbstractCollection<E>
     ...
     */
    public AccessibleArrayDeque(int numElements) {
     ...
     */
    public AccessibleArrayDeque(Collection<? extends E> c) {
        this(c.size());
        copyElements(c);
    }
     ...
     */
    @Override
    public AccessibleArrayDeque<E> clone() {
        try {
            @SuppressWarnings("unchecked")
